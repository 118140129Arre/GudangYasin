...
<body>
<p class="fs-1 text-center">Riwayat Penjumlahan Beras</p><br><br>

<center>
<table cellpadding="1" cellspacing="1">
<tr><th>
<form action="../beras/pilih+beras" method="post">
<input   type="submit" class="btn btn-primary" value="Tambah">
</form></th><th>
<form action="../beras/riwayatmin" method="post">
<input   type="submit" class="btn btn-primary" value="Riwayat Pengurangan">
</form></th><th>
<form action="../beras/pilih-beras" method="post">
...
<form action="../awal/halaman_admin" method="post">
